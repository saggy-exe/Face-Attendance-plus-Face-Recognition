...
class App:
    ...
    def login(self):
        ...
        if name in ['unknown_person', 'no_persons_found']:
            util.msg_box('Oops...', 'Unknown user. Please register user or try again')
        else:
    ...
    def accept_register_new_user(self):
        ...
        self.register_new_user_capture = cv2.imwrite(os.path.join(self.db_dir, '{}.jpg'.format(name)), self.register_new_user_capture, )
